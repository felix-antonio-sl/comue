...
def detalle_atencion(atencion_id):
    ...
    if form_historia.validate_on_submit() and form_historia.submit.data:
        ...
        form_procesar_historia.validate_on_submit()
        and form_procesar_historia.submit.data
    ):
        ...
        form_procesar_detalle.validate_on_submit() and form_procesar_detalle.submit.data
    ):
